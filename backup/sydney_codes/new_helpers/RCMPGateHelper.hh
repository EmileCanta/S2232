...
#ifndef RCMPGATEHELPER_HH
#define RCMPGATEHELPER_HH
...
class RCMPGateHelper : public TGRSIHelper, public ROOT::Detail::RDF::RActionImpl<RCMPGateHelper> {
public:
   ...
   RCMPGateHelper(TList* list) : TGRSIHelper(list)
   {
      Prefix("RCMPGate");
      Setup();
   }
...
extern "C" RCMPGateHelper* CreateHelper(TList* list) { return new RCMPGateHelper(list); }
